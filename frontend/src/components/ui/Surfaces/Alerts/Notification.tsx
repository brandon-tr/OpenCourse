        ...
        if (params.has("errors")) {
            switch (params.get("errors")) {
                ...
                case process.env.NEXT_PUBLIC_ERRORS_NOT_LOGGED_IN:
                    ...
                    break;
                case process.env.NEXT_PUBLIC_ERRORS_LOCKED:
                    showNotification("This account has been locked.", "error");
                    break;
                case process.env.NEXT_PUBLIC_ERRORS_NOT_ALLOWED:
                    showNotification("This account is not allowed to access this resource", "error");
                    break;
                case process.env.NEXT_PUBLIC_ERRORS_2FA:
                    showNotification("This account requires 2FA to sign in", "error");
                    break;
                default:
                    showNotification(
